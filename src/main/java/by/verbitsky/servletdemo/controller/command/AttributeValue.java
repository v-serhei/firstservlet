...
/**
 * This class contains constants with key values for language supporting
 * Keys used into <fmt:message> </fmt:message> tag as key value
 * <p>
 *
...
public class AttributeValue {
    ...
    /**
     * Default values for page settings, used in pagination tag
     * */
