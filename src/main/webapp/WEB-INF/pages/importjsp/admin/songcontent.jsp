        ...
        <div class="song-content-management">
            <div class="song-management-block">
                <div class="song-update-block">
                    ...
                    <form class="form-group" action="${pageContext.request.contextPath}/do/admin/song_management/update_song" method="put">
                        <div class="song-selector form-group">
                            ...
                            <select class="custom-select mr-sm-2 admin-item-selector"
                                    id="song-list" name="songId" size="1" required>
                        ...
                        <div class="singer-select-block form-group">
                            ...
                            <select class="custom-select mr-sm-2 admin-item-selector"
                                    id="singer-list" name="singerId" size="1" required>
                                <option selected value=""></option>
                        ...
                        <div class="album-select-block form-group">
                            ...
                            <select class="custom-select mr-sm-2 admin-item-selector"
                                    id="album-list" name="albumId" size="1" required>
                                <option selected value=""></option>
                        ...
                        <div class="genre-select-block form-group">
                            ...
                            <select class="custom-select mr-sm-2 admin-item-selector"
                                    id="genre-list" name="genreId" size="1" required>
                                <option selected value=""></option>
                        ...
                        <div class="song-price-block form-group">
                            ...
                            <input class="form-control" id="song-price"
                                   ...
                                   minlength="1"
                                   maxlength="10"
                                   placeholder="<fmt:message key="admin.song.manage.price.placeholder"/>"/>
                        </div>
                ...
                <div class="song-create-block">
                    ...
                    <form class="form-group" action="${pageContext.request.contextPath}/process/upload" enctype="multipart/form-data"
                          method="post">
                        <div class="song-title-block form-group">
                            <label for="song-create-name"><fmt:message key="admin.song.manage.enter.title.caption"/></label>
                            <input class="form-control" id="song-create-name"
                                   type="text"
                                   name="songName"
                                   pattern="[а-яА-Яa-zA-Z\d'\\!\\.\\-\\,\\+\s]{1,80}"
                                   required
                        ...
                        <div class="singer-select-block form-group">
                            <label for="singer-list2" style="margin: 0 auto"> <fmt:message
                                    key="admin.singer.manage.select.caption"/> </label>
                            <select class="custom-select mr-sm-2 admin-item-selector"
                                    id="singer-list2" name="singerId" size="1" required>
                                <option selected value=""></option>
                                <c:forEach var="singer" items="${singerList}">
                                    <option value="${singer.id}">${singer.singerName}</option>
                                </c:forEach>
                        ...
                        <div class="album-select-block form-group">
                            <label for="album-list2" style="margin: 0 auto"> <fmt:message
                                    key="admin.album.manage.select.caption"/> </label>
                            <select class="custom-select mr-sm-2 admin-item-selector"
                                    id="album-list2" name="albumId" size="1" required>
                                <option selected value=""></option>
                                <c:forEach var="album" items="${albumList}">
                                    <option value="${album.id}">${album.mergedTitle}</option>
                                </c:forEach>
                        ...
                        <div class="genre-select-block form-group">
                            <label for="genre-list2" style="margin: 0 auto"> <fmt:message
                                    key="admin.genre.manage.select.caption"/></label>
                            <select class="custom-select mr-sm-2 admin-item-selector"
                                    id="genre-list2" name="genreId" size="1" required>
                                <option selected value=""></option>
                                <c:forEach var="genre" items="${genreList}">
                                    <option value="${genre.id}">${genre.genreName}</option>
                                </c:forEach>
                        ...
                        <div class="song-price-block">
                            ...
                            <input class="form-control" id="song-price2"
                                   type="text"
                                   name="songPrice"
                                   pattern="^[0-9]*[.,]?[0-9]+$"
                                   required
